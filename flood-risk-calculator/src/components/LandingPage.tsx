            ...
            <section className="bg-white min-h-[80vh] py-20 flex items-center justify-center shadow-sm">
                <div className="max-w-4xl mx-auto px-6 lg:px-8 flex flex-col items-center text-center">
                    ...
                    <p className="mt-6 text-lg text-gray-600">
                        Highlighting the risks of future floods and the importance of green space.
                    </p>
                    <div className="mt-8">
                        <Link
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="text-center mb-12">
                        ...
                        <p className="mt-4 text-gray-600">
                            Discover flood risk assessment features and evaluate your property.
                        </p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        >
                            ...
                            <p className="text-gray-600">Analyze flood risks based on environmental factors.</p>
                            <div className="mt-4 text-indigo-600 font-medium hover:underline">Try Now →</div>
                        </Link>
                        ...
                        >
                            ...
                            <p className="text-gray-600">Simulate how vegetation influences flood risk.</p>
                            <div className="mt-4 text-green-600 font-medium hover:underline">Try Now →</div>
                        </Link>
                    </div>
                </div>
            </section>
